...
urlpatterns = [
    ...
    path("edit-question/<int:survey_id>/<str:question_type>/", views.edit_question_view, name="edit_question_new"),
    path("edit-question/<int:survey_id>/<str:question_type>/<int:question_id>/", views.edit_question_view, name="edit_question"),
