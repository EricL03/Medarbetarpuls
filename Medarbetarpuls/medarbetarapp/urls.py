...
urlpatterns = [
    ...
    path("move_question_left/<int:survey_temp_id>/<int:question_id>/", views.move_question_left, name="move_question_left"),
    path("move_question_right/<int:survey_temp_id>/<int:question_id>/", views.move_question_right, name="move_question_right"),
